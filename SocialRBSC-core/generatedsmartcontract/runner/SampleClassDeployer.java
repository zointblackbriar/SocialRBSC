...
/**
 * Generated Smart Contract Deployer for SampleClass
 * Auto-generated from @Deploy with full annotation scanning.
 * Detects and deploys all: @Deploy
 */
public class SampleClassDeployer {

    private static final Logger logger = Logger.getLogger(SampleClassDeployer.class.getName());
    ...
    public void deployAllContracts() throws Exception {
        ...
        // invoke method anotherMethod(int)
