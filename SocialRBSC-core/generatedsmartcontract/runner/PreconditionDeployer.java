...
/**
 * Generated Smart Contract Deployer for Precondition
 * Auto-generated from @Deploy with full annotation scanning.
 * Detects and deploys all: @Deploy
 */
public class PreconditionDeployer {

    private static final Logger logger = Logger.getLogger(PreconditionDeployer.class.getName());
    ...
    public void deployAllContracts() throws Exception {
        ...
        // @Deploy: Precondition, GoalPlanTree, Plan, PreconditionSocialAgent, PreconditionVariable, SocialAgent, SocialAgentGoal, SocialAgentPlan
