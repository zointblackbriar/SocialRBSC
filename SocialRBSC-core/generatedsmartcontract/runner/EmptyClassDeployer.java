...
/**
 * Generated Smart Contract Deployer for EmptyClass
 * Auto-generated from @Deploy with full annotation scanning.
 * Detects and deploys all: @Deploy
 */
public class EmptyClassDeployer {

    private static final Logger logger = Logger.getLogger(EmptyClassDeployer.class.getName());
