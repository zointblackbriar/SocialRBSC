...
/**
 * Generated Smart Contract Deployer for Plan
 * Auto-generated from @Deploy with full annotation scanning.
 * Detects and deploys all: @Deploy
 */
public class PlanDeployer {

    private static final Logger logger = Logger.getLogger(PlanDeployer.class.getName());
    ...
    public void deployAllContracts() throws Exception {
        ...
        // @Deploy: Plan, GoalPlanTree, Precondition, PreconditionSocialAgent, PreconditionVariable, SocialAgent, SocialAgentGoal, SocialAgentPlan
