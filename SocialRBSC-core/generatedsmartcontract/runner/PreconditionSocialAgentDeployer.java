...
/**
 * Generated Smart Contract Deployer for PreconditionSocialAgent
 * Auto-generated from @Deploy with full annotation scanning.
 * Detects and deploys all: @Deploy
 */
public class PreconditionSocialAgentDeployer {

    private static final Logger logger = Logger.getLogger(PreconditionSocialAgentDeployer.class.getName());
    ...
    public void deployAllContracts() throws Exception {
        ...
        // @Deploy: PreconditionSocialAgent, GoalPlanTree, Plan, Precondition, PreconditionVariable, SocialAgent, SocialAgentGoal, SocialAgentPlan

        // invoke method evaluate()
