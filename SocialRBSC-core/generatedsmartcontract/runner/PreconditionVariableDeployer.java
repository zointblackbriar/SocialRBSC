...
/**
 * Generated Smart Contract Deployer for PreconditionVariable
 * Auto-generated from @Deploy with full annotation scanning.
 * Detects and deploys all: @Deploy
 */
public class PreconditionVariableDeployer {

    private static final Logger logger = Logger.getLogger(PreconditionVariableDeployer.class.getName());
    ...
    public void deployAllContracts() throws Exception {
        ...
        // @Deploy: PreconditionVariable, GoalPlanTree, Plan, Precondition, PreconditionSocialAgent, SocialAgent, SocialAgentGoal, SocialAgentPlan
