...
public class ComponentRole extends Contract {
    ...
    @Deprecated
    protected ComponentRole(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected ComponentRole(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static ComponentRole load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new ComponentRole(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ComponentRole load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public static RemoteCall<ComponentRole> deploy(Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ComponentRole.class, web3j, credentials, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<ComponentRole> deploy(Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ComponentRole.class, web3j, credentials, gasPrice, gasLimit, getDeploymentBinary(), "");
    }

    public static RemoteCall<ComponentRole> deploy(Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ComponentRole.class, web3j, transactionManager, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<ComponentRole> deploy(Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ComponentRole.class, web3j, transactionManager, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
